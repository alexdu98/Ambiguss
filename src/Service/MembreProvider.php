...
use App\Exception\GenerateUsernameException;
use App\Exception\MailAlreadyUsedException;
...
class MembreProvider implements UserProviderInterface, PasswordUpgraderInterface, OAuthAwareUserProviderInterface
{
    private $container;
    private $em;
    private $session;
    ...
    {
        return $this->em->findUserByUsername($username);
    }
    ...
    private function updateServiceInfos(Membre $user, $service, $response) {
        ...
        $reflectionMethod = new ReflectionMethod('App\Entity\Membre', $method);
