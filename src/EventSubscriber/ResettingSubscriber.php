...
class ResettingSubscriber implements EventSubscriberInterface
{
    ...
    public function __construct(ContainerInterface $container)
    {
        ...
        $this->historique = $container->get('App\Service\HistoriqueService');
    ...
    {
        return [
            MembreEvents::RESETTING_SEND_EMAIL_INITIALIZE => 'sendEmailInitialize',
            MembreEvents::RESETTING_SEND_EMAIL_COMPLETED => 'sendEmailCompleted',
            MembreEvents::RESETTING_RESET_COMPLETED => 'resetCompleted'
        ];
    }
