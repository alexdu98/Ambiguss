...
class MotAmbiguPhraseRepository extends \Doctrine\ORM\EntityRepository
{
	 ...
	 * @return array
	 */
	public function findIdPhrasesNotPlayedByMembre($membre, $maxResult){
	 ...
	 * @return array
	 */
	public function findIdPhrasesNotPlayedByIpSince($ip, $since, $maxResult){
		return $this->createQueryBuilder('pma')->select('identity(pma.phrase)')->distinct()
	...
	/**
	 * Retourne un tableau de tableau avec un champ correspondant à l'id d'une phrase
	 *
	 * @return array
	 */
	public function findAllIdPhrases(){
