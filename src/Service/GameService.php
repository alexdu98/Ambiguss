...
class GameService
{
    ...
    public function getGame(?Phrase $phrase)
    {
        ...
        if(!$phrase) {
            ...
            if($isConnected)
            {
                $phrases = $phraseRepo->findIdPhrasesNotPlayedByMembre($user, $this->container->getParameter('app.dureeAvantJouabiliteSecondes'));
            }
            ...
            {
                $alreadyPlayed = true;
                $dureeAvantJouabiliteSecondes = $this->container->getParameter('app.dureeAvantJouabiliteSecondes');
                $nbPhrasesDisponiblesNonConnecte = $this->container->getParameter('app.dureeAvantJouabiliteSecondes');
    ...
    {
        $reponseRepo = $this->em->getRepository('App:Reponse');
