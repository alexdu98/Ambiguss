...
class VisiteSubscriber implements EventSubscriberInterface
{
    ...
    public function __construct(EntityManagerInterface $entityManager, ContainerInterface $container)
    {
        ...
        $this->timeBetweenTwoVisites = $container->getParameter('app.timeBetweenTwoVisitesSecondes');
    }
    ...
    public function process(GetResponseEvent $event)
    {
        ...
        if (!$event->getRequest()->cookies->has('visite')) {
            ...
            $lastVisitPerdiod = $this->em->getRepository('App:Visite')->findLastVisitPeriod($visite, $this->timeBetweenTwoVisites);
