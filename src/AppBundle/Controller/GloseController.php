...
class GloseController extends Controller
{
	...
	public function editGloseAction(Request $request, \AppBundle\Entity\Glose $glose)
	{
		if($this->get('security.authorization_checker')->isGranted('ROLE_MODERATEUR'))
		{
			if($this->get('security.authorization_checker')->isGranted('IS_AUTHENTICATED_FULLY'))
	...
	public function deleteGloseAction(\AppBundle\Entity\Glose $glose)
	{
		if($this->get('security.authorization_checker')->isGranted('ROLE_MODERATEUR'))
		{
			if($this->get('security.authorization_checker')->isGranted('IS_AUTHENTICATED_FULLY'))
	...
	public function linkGloseAction(\AppBundle\Entity\Glose $glose)
	{
		if($this->get('security.authorization_checker')->isGranted('ROLE_MODERATEUR'))
		{
			if($this->get('security.authorization_checker')->isGranted('IS_AUTHENTICATED_FULLY'))
