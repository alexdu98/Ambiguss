...
use App\Util\InvalidPhraseMessage;
...
class Phrase implements \JsonSerializable
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Membre", inversedBy="phrases")
	...
	/**
	 * @ORM\OneToMany(targetEntity="App\Entity\MotAmbiguPhrase", mappedBy="phrase", cascade={"persist", "remove"})
	...
	/**
	 * @ORM\OneToMany(targetEntity="App\Entity\Partie", mappedBy="phrase", cascade={"remove"})
	 */
	private $parties;
